...
struct StoreContractsTests {
    ...
    func uiSettingsStoreRoundtrip() {
        ...
        store.saveSidebarDisplayMode(.expanded)
        ...
        store.saveExperimentalElevatedDeletion(true)
        ...
        #expect(store.loadSidebarDisplayMode() == .expanded)
        ...
        #expect(store.loadExperimentalElevatedDeletion() == true)
